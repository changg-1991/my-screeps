        ...
        if (structure.room.name == 'W98S23') {
            var closestHostile = structure.pos.findClosestByRange(FIND_HOSTILE_CREEPS, {
                filter: function(object) {
                    return Memory.ally.indexOf(object.owner.username) == -1 && (object.pos.x < 40 || (object.pos.x == 45 && object.pos.y == 1) || (object.pos.x == 45 && object.pos.y == 2));
                }
            });
            ...
            var closestHostile = structure.pos.findClosestByRange(FIND_HOSTILE_CREEPS, {
                filter: function(object) {
                    return Memory.ally.indexOf(object.owner.username) == -1 && object.pos.x < 40;
                }
            });
